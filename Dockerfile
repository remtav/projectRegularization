...
RUN cd /home/$USERNAME && git clone --depth 1 "https://github.com/remtav/projectRegularization.git" --branch $GIT_TAG
RUN conda config --set ssl_verify no
RUN conda install mamba -c conda-forge
RUN mamba env create -f /home/$USERNAME/projectRegularization/environment.yml
